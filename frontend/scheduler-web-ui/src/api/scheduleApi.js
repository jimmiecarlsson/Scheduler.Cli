...
export async function updateMyContributorProfile(dto) {
    const res = await http.put("/api/schedule/contributors/me", dto);
    return res.data;
}
...
export async function updateContributorRates(userId, dto) {
    return http.put(`/api/schedule/users/${userId}/rates-contributor`, dto)
        .then(r => r.data);
}
